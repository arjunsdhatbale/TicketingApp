...
<html>
<head>
    <title>Not Assigned Tickets</title>
    <!-- Bootstrap 5 (if not already in header.jsp) -->
...
<h2 class="text-danger mb-3">📝 Not Assigned Tickets</h2>
        ...
        <tbody>
            <c:forEach var="ticket" items="${tickets}">
                <tr>
                    ...
                    <td>
                        <form action="${pageContext.request.contextPath}/progress/assign" method="post" class="d-flex flex-column gap-2">
